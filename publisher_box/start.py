...
class RedisConnector:
    ...
    def publish(self, queue_name, message):
        ...
        :rtype: None
        """
        self._redis.publish(queue_name, message)
...
redis_subscriber = RedisConnector(HOST, PORT, QUEUES, MICRO_SERVICE_NAME)
t = 1
while True:
    message = {
        "target": 'processor',
    ...
    redis_subscriber.publish(QUEUENAME, json.dumps(message))
    t += 1
